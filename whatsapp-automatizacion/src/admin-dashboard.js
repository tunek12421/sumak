...
<head>
    ...
    <style>
        * {
        ...
        .badge-sumak { background: #e0f7ff; color: #0066cc; }
        .badge-ugr { background: #ffe0e0; color: #cc0000; }
...
<body>
    <header>
        <h1>🚨 Sistema de Emergencias Municipal - Panel de Control</h1>
    </header>
        ...
        <div class="top-section">
            ...
            <div class="stats-column">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Tasa Clasificación</div>
                </div>
            </div>
